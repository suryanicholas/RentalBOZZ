...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        navItems1.setText("Kendaraan Baru");
        ...
        tableColumn1.setText("No Polisi");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT * FROM mobil LIMIT 10")){
                ResultSet Results = Statements.executeQuery();
                int index = 0;
                while(Results.next()){
                    switch (index){
                        case 0 ->{
                            tableR0C1.setText(Results.getString("Polisi"));
                            tableR0C2.setText(Results.getString("Merek"));
                            tableR0C3.setText(Results.getString("Model"));
                            tableR0C4.setText(Results.getString("Status"));
                            tableR0C5 = Results.getInt("ID");
                        }
                        case 1 ->{
                            tableR1C1.setText(Results.getString("Polisi"));
                            tableR1C2.setText(Results.getString("Merek"));
                            tableR1C3.setText(Results.getString("Model"));
                            tableR1C4.setText(Results.getString("Status"));
                            tableR1C5 = Results.getInt("ID");
                        }
                        case 2 ->{
                            tableR2C1.setText(Results.getString("Polisi"));
                            tableR2C2.setText(Results.getString("Merek"));
                            tableR2C3.setText(Results.getString("Model"));
                            tableR2C4.setText(Results.getString("Status"));
                            tableR2C5 = Results.getInt("ID");
                        }
                        case 3 ->{
                            tableR3C1.setText(Results.getString("Polisi"));
                            tableR3C2.setText(Results.getString("Merek"));
                            tableR3C3.setText(Results.getString("Model"));
                            tableR3C4.setText(Results.getString("Status"));
                            tableR3C5 = Results.getInt("ID");
                        }
                        case 4 ->{
                            tableR4C1.setText(Results.getString("Polisi"));
                            tableR4C2.setText(Results.getString("Merek"));
                            tableR4C3.setText(Results.getString("Model"));
                            tableR4C4.setText(Results.getString("Status"));
                            tableR4C5 = Results.getInt("ID");
                        }
                        case 5 ->{
                            tableR5C1.setText(Results.getString("Polisi"));
                            tableR5C2.setText(Results.getString("Merek"));
                            tableR5C3.setText(Results.getString("Model"));
                            tableR5C4.setText(Results.getString("Status"));
                            tableR5C5 = Results.getInt("ID");
                        }
                        case 6 ->{
                            tableR6C1.setText(Results.getString("Polisi"));
                            tableR6C2.setText(Results.getString("Merek"));
                            tableR6C3.setText(Results.getString("Model"));
                            tableR6C4.setText(Results.getString("Status"));
                            tableR6C5 = Results.getInt("ID");
                        }
                        case 7 ->{
                            tableR7C1.setText(Results.getString("Polisi"));
                            tableR7C2.setText(Results.getString("Merek"));
                            tableR7C3.setText(Results.getString("Model"));
                            tableR7C4.setText(Results.getString("Status"));
                            tableR7C5 = Results.getInt("ID");
                        }
                        case 8 ->{
                            tableR8C1.setText(Results.getString("Polisi"));
                            tableR8C2.setText(Results.getString("Merek"));
                            tableR8C3.setText(Results.getString("Model"));
                            tableR8C4.setText(Results.getString("Status"));
                            tableR8C5 = Results.getInt("ID");
                        }
                        case 9 ->{
                            tableR9C1.setText(Results.getString("Polisi"));
                            tableR9C2.setText(Results.getString("Merek"));
                            tableR9C3.setText(Results.getString("Model"));
                            tableR9C4.setText(Results.getString("Status"));
    ...
    private void navItems1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navItems1ActionPerformed
        dispose();
        SwingUtilities.invokeLater(() -> new ROOT.Kendaraan.Buat().setVisible(true));
    ...
    private void navBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navBackActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT * FROM mobil LIMIT 10 OFFSET ?")){
    ...
    private void navNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navNextActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            ...
            String Query = "SELECT * FROM mobil LIMIT 10 OFFSET " + selectorOffset;
