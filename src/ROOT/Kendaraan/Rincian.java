...
public class Rincian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        navItems1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_FILL0_wght400_GRAD0_opsz24.png"))); // NOI18N
        navItems1.setText("Ubah");
        ...
        navItems2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/delete_FILL0_wght400_GRAD0_opsz24.png"))); // NOI18N
        navItems2.setText("Hapus");
    ...
    private void navItems1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navItems1ActionPerformed
        dispose();
        SwingUtilities.invokeLater(() -> new ROOT.Kendaraan.Ubah().setVisible(true));
    ...
    private void navItems2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navItems2ActionPerformed
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
              String Query = "DELETE FROM mobil WHERE ID=" + selectedDetails;
              try(PreparedStatement Statements = DB.prepareStatement(Query)){
