...
public class Main extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT P.ID, C.Nama AS A, M.Merek AS B, P.Mulai AS C, P.Status AS D FROM peminjaman P JOIN mobil M ON M.ID = P.Mobil JOIN penyewa C ON C.ID = P.Penyewa WHERE P.Selesai > CURRENT_DATE() AND P.Status = 'Lunas' LIMIT 10")){
    ...
    private void navBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navBackActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT P.ID, C.Nama AS A, M.Merek AS B, P.Mulai AS C, P.Status AS D FROM peminjaman P JOIN mobil M ON M.ID = P.Mobil JOIN penyewa C ON C.ID = P.Penyewa WHERE P.Selesai > CURRENT_DATE() AND P.Status = 'Lunas' LIMIT 10 OFFSET ?")){
    ...
    private void navNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navNextActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            ...
            String Query = "SELECT P.ID, C.Nama AS A, M.Merek AS B, P.Mulai AS C, P.Status AS D FROM peminjaman P JOIN mobil M ON M.ID = P.Mobil JOIN penyewa C ON C.ID = P. WHERE P.Selesai > CURRENT_DATE() AND P.Status = 'Lunas' LIMIT 10 OFFSET " + selectorOffset;
    ...
    private void tableButton0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tableButton0ActionPerformed
        ...
        dispose();
        SwingUtilities.invokeLater(() -> new ROOT.Pengembalian.Rincian().setVisible(true));
