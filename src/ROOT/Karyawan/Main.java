...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        navItems1.setText("Karyawan Baru");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT K.ID, K.Nama AS A, K.Username AS B, U.Nama AS C, K.Gender AS D FROM karyawan K LEFT JOIN utype U ON U.ID = K.Posisi LIMIT 10")){
    ...
    private void navItems1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navItems1ActionPerformed
        dispose();
        SwingUtilities.invokeLater(() -> new ROOT.Karyawan.Buat().setVisible(true));
    ...
    private void navBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navBackActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT K.ID, K.Nama AS A, K.Username AS B, U.Nama AS C, K.Gender AS D FROM karyawan K LEFT JOIN utype U ON U.ID = K.Posisi LIMIT 10 OFFSET ?")){
    ...
    private void navNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_navNextActionPerformed
        ...
        try(Connection DB = DriverManager.getConnection(DBNAME, DBUSER, DBPASS)){
            try(PreparedStatement Statements = DB.prepareStatement("SELECT COUNT(*) AS listTotal FROM karyawan")){
                ResultSet Results = Statements.executeQuery();
                if(Results.next()){
            ...
            String Query = "SELECT K.ID, K.Nama AS A, K.Username AS B, U.Nama AS C, K.Gender AS D FROM karyawan K LEFT JOIN utype U ON U.ID = K.Posisi LIMIT 10 OFFSET " + selectorOffset;
